...
const layout: VehicleTypeLayout = {
  Edit: ['name', 'shortName', 'description', 'transportMode', 'length', 'width', 'height', 'weight', 'lowFloor'],
  Propulsion: ['propulsionTypes', 'fuelTypes', 'selfPropelled', 'maximumVelocity', 'maximumRange'],
  Capacity: ['totalCapacity', 'seatingCapacity', 'standingCapacity', 'wheelchairPlaceCapacity', 'pramPlaceCapacity', 'bicycleRackCapacity', 'fareClass'],
  Environment: ['formDragCoefficient', 'rollResistanceCoefficient', 'maximumEngineEffectKW', 'hybridCategory'],
};
